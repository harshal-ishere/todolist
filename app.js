...
mongoose.connect("mongodb+srv://harshalk:b4icunokmidown@todolist.zndemun.mongodb.net/?retryWrites=true&w=majority"); //this line is use to connect to the mongodb server to the port 27017 and make a new database todolist
